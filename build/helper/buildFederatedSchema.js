...
function buildFederatedSchema(options, referenceResolvers) {
    return __awaiter(this, void 0, void 0, function () {
        var schema, federatedSchema;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, type_graphql_1.buildSchema)(__assign(__assign({}, options), { skipCheck: true }))];
                case 1:
                    schema = _a.sent();
                    federatedSchema = (0, subgraph_1.buildSubgraphSchema)({
                        typeDefs: (0, graphql_tag_1.default)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n\t\t\textend schema @link(url: \"https://specs.apollo.dev/federation/v2.5\", import: [\"@key\"])\n\t\t\t", "\n    \t"], ["\n\t\t\textend schema @link(url: \"https://specs.apollo.dev/federation/v2.5\", import: [\"@key\"])\n\t\t\t", "\n    \t"])), (0, utils_1.printSchemaWithDirectives)(schema)),
                    ...
                    return [2 /*return*/, federatedSchema];
            }
        });
    });
}
